...
public class DonHangChiTietApdapter2 extends ArrayAdapter<DonHangChiTiet> {
    private Context context;
    XemDonHangActivity activity;
    private ArrayList<DonHangChiTiet> lists;
    TextView tvTenSP, tvSLDG ,tvThanhTien;
    SanPhamDAO sanPhamDAO;

    public DonHangChiTietApdapter2(Context context, XemDonHangActivity activity, ArrayList<DonHangChiTiet> lists) {
